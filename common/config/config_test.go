...
func TestLoadConfig(t *testing.T) {
	conf, err := NewConfig("testdata/efc-agent.conf", nil)
	...
	expectedConf := &Config{
		...
		LoggingConfig: LoggingConfig{
			LogLevel: "debug",
			LogFile:  "/tmp/efc-agent-testing.log",
		},
	}
